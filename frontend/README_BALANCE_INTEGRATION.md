...
- Баланс автоматически загружается при входе пользователя
- Баланс сохраняется в `localStorage` для быстрого доступа
- При каждом обновлении баланс синхронизируется с сервером
- При выходе баланс очищается из `localStorage`
