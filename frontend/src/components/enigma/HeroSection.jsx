  ...
  <div className="min-h-screen relative overflow-x-hidden">
      ...
      <div className="text-center relative z-10 max-w-4xl mx-auto space-y-8">
        ...
        <div className="pt-4">
          <Button
            type="button"
            onClick={onStart}
            className="px-12 py-4 text-lg bg-cyan-400 text-black hover:bg-cyan-300 transition-all shadow-[0_0_30px_rgba(0,255,255,0.6)] hover:shadow-[0_0_50px_rgba(0,255,255,1)] hover:scale-105"
          >
            НАЧАТЬ ИГРУ
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
          ...
          <div className="p-8 border-2 border-cyan-400/30 rounded-lg bg-[#0a0a0f]/80 backdrop-blur-sm shadow-[0_0_30px_rgba(0,255,255,0.2)]">
            ...
            <p className="text-cyan-200/80 leading-relaxed">
              ENIGMA — результат страсти к играм, технологиям и образованию. Мы верим,
        ...
        <div className="mt-16 text-center">
          <div className="inline-block p-8 border-2 border-cyan-400 rounded-lg bg-gradient-to-br from-cyan-400/10 to-cyan-300/5 shadow-[0_0_40px_rgba(0,255,255,0.3)]">
            ...
            <Button
              type="button"
              onClick={onStart}
              className="px-10 py-4 text-lg bg-cyan-400 text-black hover:bg-cyan-300 transition-all shadow-[0_0_30px_rgba(0,255,255,0.6)] hover:shadow-[0_0_50px_rgba(0,255,255,1)] hover:scale-105"
            >
    ...
    <footer className="relative py-8 border-t-2 border-cyan-400/30">
      <div className="max-w-6xl mx-auto px-4 text-center">
        <p className="text-cyan-200/80 text-sm">
          © 2025 ENIGMA. Все права защищены.
        </p>
